...
Le code du jeu est a la racine du projet. Les dossiers `Noelle/`, `Noelle/Alt/` et `Spamton/` contiennent les skins ; `Noelle/` contient aussi les textures de talkbox.
